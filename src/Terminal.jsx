...
export default function Terminal() {
  ...
  useEffect(() => {
    ...
    if (currentUser) {
      setUser(currentUser);
      setCurrentPath(`/home/${currentUser.username}`);
      // Initialize user's home directory
      fileService.createDirectory('/home', currentUser.username);
    } else {
  ...
  if (!user) {
    return <div className="terminal-loading">Loading terminal...</div>;
  }
